...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "BOATS_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 40 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence COMMITTEE_ID
--------------------------------------------------------

   CREATE SEQUENCE  "COMMITTEE_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 860 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence EMAIL_TEMPLATE_ID
--------------------------------------------------------

   CREATE SEQUENCE  "EMAIL_TEMPLATE_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 123 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence FEESRECORDS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "FEESRECORDS_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 19084 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence IMPORTANT_VALUES_ID
--------------------------------------------------------

   CREATE SEQUENCE  "IMPORTANT_VALUES_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 101 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence LOTTERY_ID
--------------------------------------------------------

   CREATE SEQUENCE  "LOTTERY_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 4405 CACHE 2 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence MEMBERS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "MEMBERS_ID"  MINVALUE 1000 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 6563 CACHE 2 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence REGATTAS_EXT_ID
--------------------------------------------------------

   CREATE SEQUENCE  "REGATTAS_EXT_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 2621 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence REGATTAS_IN_SERIES_ID
--------------------------------------------------------

   CREATE SEQUENCE  "REGATTAS_IN_SERIES_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 221 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence REGATTA_PARTICIPATION_ID
--------------------------------------------------------

   CREATE SEQUENCE  "REGATTA_PARTICIPATION_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 26174 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence REGATTA_PROFILES_ID
--------------------------------------------------------

   CREATE SEQUENCE  "REGATTA_PROFILES_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 12224 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence REGATTA_SERIES_EXT_ID
--------------------------------------------------------

   CREATE SEQUENCE  "REGATTA_SERIES_EXT_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 181 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence S_EMAIL_QUEUE
--------------------------------------------------------

   CREATE SEQUENCE  "S_EMAIL_QUEUE"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 42922 CACHE 10 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence S_IMPORTANT_DATES
--------------------------------------------------------

   CREATE SEQUENCE  "S_IMPORTANT_DATES"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 261 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence S_LOTTERY_RESULTS
--------------------------------------------------------

   CREATE SEQUENCE  "S_LOTTERY_RESULTS"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 9681 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence TEACHERS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "TEACHERS_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1304 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence THURSDAY_KEY_ID
--------------------------------------------------------

   CREATE SEQUENCE  "THURSDAY_KEY_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 31 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Table ADMIN
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ACTIVE_MEMBERS_LICENCE_LIST" ("ID", "NAME", "FIRSTNAME", "LICENCE_ID") AS
  SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ADMIN_RIGHTS" ("MEMBER_ID", "NAME", "FIRSTNAME", "RIGHTS", "RIGHT", "MODIFIED", "COMMENTS") AS
  SELECT
    ADMIN.MEMBER_ID,
    MEMBERS.NAME,
    MEMBERS.FIRSTNAME,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BA5_EG" ("PREFIX", "K_NAME", "ID", "KEYID", "NAME", "FIRSTNAME", "ASSIGNED_DATE", "RETURN_DATE", "LAST_VERIF", "COMMENTS") AS
  SELECT
    BA5.PREFIX,
    BA5.NAME K_name,
    MEMBERS.ID,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BOATS_ON_KEYS_DISTRIBUTOR" ("BOAT_ID", "NAME", "TYPE", "LICENSE", "CLASS", "TABLE_POS", "YCC_NUM", "KEY_NR", "VIRTUAL") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BOATS_VIEW" ("BOAT_ID", "NAME", "TYPE", "LICENSE", "CLASS", "TABLE_POS", "KEY_NR") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BOAT_LOGS" ("BOAT_NAME", "LOG_DATE", "AUTHOR", "STATUS", "LOG") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "CURRENT_COMMITTEE" ("ID", "FIRSTNAME", "NAME", "E_MAIL", "LOGON_ID", "CYEAR") AS
  SELECT mc.id,
    mc.FIRSTNAME,
    mc.name,
    mc.E_MAIL,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "CURRENT_DINGHY_COURSE_ALL" ("MEMBER_ID", "FIRSTNAME", "NAME", "E_MAIL") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "FAVOURITE_MAIL_PAPER_EG" ("NAME", "FIRSTNAME", "MEMBERSHIP", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE") AS
  SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "FEESRECORDS_TOTALS" ("MEMBER_ID", "YEAR_F", "TOTAL_PAID") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "GENDERANDLICENCES" ("ID", "NAME", "FIRSTNAME", "NATIONALITY", "MEMBERSHIP", "LANG1", "CATEGORY", "MEMBER_ENTRANCE", "GENDER", "BIRTH", "LICENCE_ID", "NLICENCE", "LYEAR") AS
  SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "GLOBAL_WEB_LOGON" ("MEMBER_ID", "LOGON_ID", "LOGON_PASSWD", "FIRSTNAME", "NAME", "E_MAIL", "ACCESS_TYPE") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "KEY_LOGS_VIEW" ("NAME", "FIRSTNAME", "BNAME", "TAKEN", "RETURNED") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LATEST_REGATTA_PROFILES" ("ID", "MEMBER_ID", "PROFILE_YEAR", "LICENCE", "CLUB", "EXPERIENCE") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LEVEL0LOTTERY" ("NAME", "FIRSTNAME", "LEVEL0") AS
  SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LICENCES_BOAT" ("ID", "NAME", "FIRSTNAME", "LICENCE_ID") AS
  SELECT
    id, name, firstname, licence_id
FROM
 members, licences, feesrecords
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LICENCES_VIEW" ("ID", "NAME", "FIRSTNAME", "LICENCE_ID", "NLICENCE", "LYEAR", "LCOMMENTS") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LIST_LOTTERY_NOT_SELECTED" ("NAME", "FIRSTNAME", "E_MAIL", "YEAR", "WITHDRAWN", "WD_COMMENT") AS
  SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LOTTERY_APPLICATIONS" ("MEMBER_ID", "FIRSTNAME", "LASTNAME", "E_MAIL", "Preferred_Course", "Second_Choice", "Preferred_days") AS
  with m as (
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LOTTERY_RANKING" ("KEY", "MEMBER_ID", "DRAWN_SEQ", "ORDER1", "ORDER2", "FIRSTNAME", "NAME", "E_MAIL", "WEEKDAYS", "SCORE", "AVAILABLE_PLACES") AS
  with
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MAINTAINERS" ("BNAME", "BTYPE", "LICENSE", "CLASS", "MNAME", "FIRSTNAME", "E_MAIL") AS
  SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERLABELS2003JUL31" ("ID", "LANG1", "NAME", "FIRSTNAME", "A1", "A2", "AC", "AT", "WORK_STATE") AS
  select
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERSPAPERADDRESS" ("ID", "NAME", "FIRSTNAME", "MEMBERSHIP", "CATEGORY", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_CURRENT" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_CURRENT_BEFORE_2010" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP") AS
  SELECT DISTINCT m.ID, NAME, FIRSTNAME, E_MAIL, MEMBERSHIP FROM MEMBERS M inner join FEESRECORDS F on M.ID=F.MEMBER_ID
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_CURRENT_WITHNAT" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP", "NATIONALITY", "ENAME") AS
  SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_CURRENT_WITH_CATEGORY" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP", "CATEGORY") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_ENTRANCE" ("NAME", "FIRSTNAME", "MEMBERSHIP", "MEMBER_ENTRANCE") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_NATIONALITY" ("ID", "LOGON_ID", "NAME", "FIRSTNAME", "WORK_PHONE", "HOME_PHONE", "CELL_PHONE", "E_MAIL", "MEMBER_ENTRANCE", "E_DESC", "CATEGORY", "NATIONALITY") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_PREVIOUS_YEAR" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP") AS
  SELECT DISTINCT m.ID, NAME, FIRSTNAME, E_MAIL, MEMBERSHIP FROM MEMBERS M inner join old_member_payments omp on M.ID=omp.MEMBER_ID
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_RIGHTS" ("NAME", "FIRSTNAME", "RES", "Key", "MEM", "LIC", "RIG", "MODIFIED", "COMMENTS") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MGV_ALL_CATALOG_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MGV_ALL_SCHEMA_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MY_CURRENT_MEMBERS" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP") AS
  SELECT DISTINCT m.ID, NAME, FIRSTNAME, E_MAIL, MEMBERSHIP FROM MEMBERS M inner join old_member_payments omp on M.ID=omp.MEMBER_ID
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "M_KEY" ("NAME", "FIRSTNAME", "LYEAR") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "NEW_MEMBER_PAYMENTS" ("MEMBER_ID", "LOGON_ID", "MEMBERSHIP_TYPE", "ENTRANCE_FEE", "ANNUAL_FEE", "KEY", "COURSEFEE", "COURSE_NAME", "PRINT_RECEIVED") AS
  select
ma.id member_id,
ma.logon_id,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "NO_MORE_JUNIORS" ("ID", "NAME", "FIRSTNAME", "BIRTHDAY") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "OLD_MEMBER_PAYMENTS" ("MEMBER_ID", "LOGON_ID", "NEW_MEMBERSHIP_TYPE", "OLD_MEMBERSHIP", "NEW_MEMBERSHIP", "ENTRANCE_FEE", "ANNUAL_FEE", "KEY", "COURSEFEE", "COURSE_NAME", "TOTAL_PAID_CURR_M_Y", "TOTAL_PAID_PREV_M_Y") AS
  select
m.id member_id,
wl.logon_id,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "OLD_SWS_TO_BE_SENT" ("ID", "NAME", "FIRSTNAME", "BIRTHDAY", "MEMBERSHIP", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "E_MAIL", "LANG1") AS
  SELECT DISTINCT
    MEMBERS.ID,
    MEMBERS.NAME,
    MEMBERS.FIRSTNAME,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PAIMENT_INVOICES" ("ID", "NAME", "FIRSTNAME", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "CATEGORY", "MEMBERSHIP", "BIRTHDAY") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PAPER_MAILING" ("ID", "FIRSTNAME", "NAME", "BIRTHDAY", "LANG", "MEMBERSHIP_TYPE", "ADDRESS1", "ADDRESS2", "TOWN", "COUNTRY", "IS_CERN_ADDRESS", "LAST_PAID_YEAR") AS
  select
	id,
	firstname,
	name,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "REGATTA_PROFILES_RECENT" ("ID", "MEMBER_ID", "PROFILE_YEAR", "LICENCE", "CLUB", "EXPERIENCE") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "RES_VIEW" ("RES_ID", "OWNER", "BOAT", "LABEL", "DAY", "PERIOD", "DELETED", "MODIFIED") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "STATISTICS_MEMBERS" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP", "NATIONALITY", "MEMBER_ENTRANCE", "CATEGORY") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "STILL_JUNIORS" ("ID", "NAME", "FIRSTNAME", "BIRTHDAY") AS
  SELECT id, name, firstname, birthday
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SWS_LIST_SENT" ("ID", "CATEGORY", "NAME", "FIRSTNAME", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "E_MAIL", "SWS_YEAR", "SENT_TO_SWS_DATE", "COMMENTS", "BIRTHDAY") AS
  SELECT
    MEMBERS.ID,
    MEMBERS.CATEGORY,
    MEMBERS.NAME,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SW_TOBE_SENT" ("ID", "NAME", "FIRSTNAME", "BIRTHDAY", "GENDER", "MEMBERSHIP", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "E_MAIL", "LANG1", "CATEGORY") AS
  SELECT DISTINCT
    MEMBERS_CURRENT.ID,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TEACHERS_LIST" ("MNAME", "FIRSTNAME", "LICENSE", "ACTIVE", "SINCE") AS
  SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TESTS_VIEW" ("TEST_DATE", "FIRSTNAME", "NAME", "TESTER_F", "TESTER_N", "TEST_TYPE", "RESULT", "COMMENTS") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TOBESET_AS_EXPIRED" ("NLICENCE", "MEMBER_ID", "LICENCE_ID", "LYEAR", "LCOMMENTS", "TEST_ID", "STATUS", "ID", "NAME", "FIRSTNAME", "BIRTHDAY", "NATIONALITY", "MEMBERSHIP", "TEMP_MEMB", "LANG1", "LANG2", "CATEGORY", "WORK_ADDRESS1", "WORK_ADDRESS2", "WORK_TOWNCODE", "WORK_TOWN", "WORK_STATE", "WORK_PHONE", "E_MAIL", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "HOME_PHONE", "MAIL_PREFERENCE", "FAVOURITE_MAILING_POST", "MEMBER_ENTRANCE", "CELL_PHONE", "GENDER", "VALID_UNTIL_DATE", "LAST_UPDATED_DATE") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "V1" ("ID", "LANG1", "NAME", "FIRSTNAME", "A1", "A2", "AC", "AT", "ASTATE") AS
  select
 distinct id,lang1,name,firstname,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW1" ("NAME", "FIRSTNAME", "ID", "E_MAIL", "WORK_PHONE", "CELL_PHONE", "HOME_PHONE") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW2" ("MEMBER_ID", "PAID_DATE", "YEAR_F", "ENTERED_DATE", "FEE") AS
  SELECT
    MEMBER_ID,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW3" ("ID", "NAME", "FIRSTNAME", "BIRTHDAY", "MEMBERSHIP", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "E_MAIL", "LANG1") AS
  SELECT DISTINCT
    MEMBERS.ID,
    MEMBERS.NAME,
    MEMBERS.FIRSTNAME,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW4" ("ID", "NAME", "FIRSTNAME", "BIRTHDAY", "MEMBERSHIP", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "E_MAIL", "LANG1") AS
  SELECT DISTINCT
    MEMBERS.ID,
    MEMBERS.NAME,
    MEMBERS.FIRSTNAME,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW5" ("ID", "NAME", "FIRSTNAME") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW6" ("ID", "NAME", "FIRSTNAME") AS
  SELECT DISTINCT
    MEMBERS.ID,
    MEMBERS.NAME,
    MEMBERS.FIRSTNAME
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW7" ("B", "Y") AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW9_OBSOLETE" ("NAME", "FIRSTNAME", "YEAR_F", "PAID_DATE", "PAID_MODE", "FEE", "ENTERED_DATE", "PAYMENTID") AS
  SELECT MEMBERS.NAME,
    MEMBERS.FIRSTNAME,
    FEESRECORDS.YEAR_F,
    FEESRECORDS.PAID_DATE,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_MEMBERSHIP_APPS_LU" BEFORE INSERT OR UPDATE ON ycc.membership_applications for each row BEGIN
  IF INSERTING THEN
...
**************************************************************************************/
	...
	RETURN VARCHAR2 IS
	BEGIN
		RETURN 'Bank Account : <br><br>UBS Gen�ve-CERN <br>Compte: 279-C7754544.0 <br>Clearing no. : 279<br>Account no. : C7754544.0';
	END;

	FUNCTION PTTaccount
	RETURN VARCHAR2 IS
	BEGIN
		RETURN 'Post Account : <br><br>PTT<br>Compte: 12-13854-9<br>Yachting Club du CERN<br>Gen�ve';
	END;
...
PROCEDURE Renewal(mid NUMBER) IS
	...
	BEGIN
	  ...
	  IF rec.lang1 = 'F' THEN
	  	...
	  	htp.hr;
	  	htp.print(Font(-1)||htf.bold(rec.name||', '||rec.firstname)||htf.br||'Bonjour, Si vous souhaitez vous r�inscrire pour la saison '||TO_CHAR(sysdate,'YYYY')||', veuillez svp, ');
	  	...
	  	END IF;
			...
			htp.print('Merci aussi de verifier si les donnes qui vous concernent, sont justes, et eventuellement ajouter les informations qui manquent ou apporter les corrections n�cessaires
	  		                   ...
	  		                   <br>ou merci de marquer directement les changements, signer cette feuille et la renvoyer d�s que possible �  :<BR> ');
	  	htp.print(htf.center(YCCaddress));

      htp.print(htf.bold('A noter aussi')||' sp�cifiez par quel moyen vous d�sirez recevoir les communications YCC (�mail, poste, etc) - Par d�faut, l''YCC envoie ses communications par �mail.');
	  	htp.br;

	  	htp.hr;
	  	htp.print('<center>'||htf.bold('Ci-dessous, une copie de votre fichier: SVP remplissez les champs vides.'));
	  	htp.br;
	  	htp.print('(Toutes les informations personnelles resteront r�serv�es � la base de donn�e du YCC)</center>');
			htp.br;
	  	...
	  	htp.br;htp.br;
	  	htp.print('Votre langue pr�f�r�e :'||htf.bold('Francais'));
	  	htp.br;
	  	htp.print('Vous �tes membre  :'||htf.bold(MembershipList(rec.membership,rec.lang1)));
	  	htp.br;
	  	htp.print('Votre date de naissance(obligatoire pour les Juniors)  :'||htf.bold(TO_CHAR(rec.birthday,'DD-MM-YYYY')));
	  	htp.br;
	  	htp.print('Votre nationalit� :'||htf.bold(Nationality(rec.nationality,rec.lang1)));
	  	htp.br;
	  	htp.print('Votre moyen pr�f�r� pour communications :');
	  	IF rec.mail_preference = 'E' THEN
	  		htp.print(htf.bold('Message �lectronique'));
	  	ELSE
	  		IF rec.favourite_mailing_post = 'h' THEN
	  			htp.print(htf.bold('Poste a votre adresse priv�e'));
	  		ELSE
	  			htp.print(htf.bold('Poste a votre adresse professionelle'));
	  		END IF;
	  	END IF;
	  	htp.br;
	  	htp.print('Vous �tes cat�gorie  :');
	  	...
	  	htp.br;
			...
			IF rec.favourite_mailing_post = 'h' THEN
	  			htp.print('Votre Adresse (priv�e):');
	  			htp.br;
	  	...
	  	END IF;
			htp.br;
			htp.br;
			htp.print('Tel priv�e: <B>'||rec.home_phone||'</B>');
			htp.br;
...
PROCEDURE NewMemberFile(mid NUMBER) IS
	...
	BEGIN
	  ...
	  IF rec.lang1 = 'F' THEN
	  	...
	  	htp.TableRowOpen;
	  	htp.TableData(Font(-1)||'Votre langue pr�f�r�e :');
	  	htp.TableData(Font(-1)||'<b>Francais</b>');
	  	htp.TableRowClose;
	  	htp.TableRowOpen;
	  	htp.TableData(Font(-1)||'Vous �tes membre  :');
	  	...
	  	htp.TableRowClose;
	  	htp.TableRowOpen;
	  	htp.TableData(Font(-1)||'Votre nationalit� :');
	  	htp.TableData(Font(-1)||'<b>'||Nationality(rec.nationality,rec.lang1)||'</B>');
	  	htp.TableRowClose;
	  	htp.TableRowOpen;
	  	htp.TableData(Font(-1)||'Votre moyen pr�f�r� pour communications :');
	  	IF rec.mail_preference = 'E' THEN
	  		htp.TableData(Font(-1)||'<b>Message �lectronique</b>',null,null,null,null,null,'VALIGN=BOTTOM');
	  	ELSE
	  		IF rec.favourite_mailing_post = 'h' THEN
	  			htp.TableData(Font(-1)||'<b>Poste a votre adresse priv�e</b>');
	  		ELSE
	  	...
	  	htp.TableRowClose;
	  	htp.TableRowOpen;
	  	htp.TableData(Font(-1)||'Vous �tes cat�gorie  :',null,null,null,null,null,'VALIGN=TOP');
	  	IF rec.category = 'C' THEN
	  	...
	  	htp.TableOpen(null,null,null,null,'WIDTH="100%" NOSAVE');
			htp.TableRowOpen;
			htp.TableHeader(Font(-1)||'Votre Adresse priv�e:','LEFT');
...
--------------------------------------------------------
  ...
  ALTER TABLE "BOATS" MODIFY ("YCC_NUM" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "NATIONALITIES" MODIFY ("NATID" NOT NULL ENABLE);
--------------------------------------------------------
