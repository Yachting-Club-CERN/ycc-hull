...
def generate_helper_tasks() -> List[HelperTaskEntity]:
    ...
    return [
        ...
        HelperTaskEntity(
            ...
            contact_id=1,
            start=datetime(CURRENT_YEAR, 1, 4, 15, 0, 0),
            end=datetime(CURRENT_YEAR, 1, 4, 18, 0, 0),
            deadline=None,
            helpers_min_count=1,
            helpers_max_count=2,
            urgent=False,
        ...
        HelperTaskEntity(
            ...
            deadline=datetime(CURRENT_YEAR, 1, 5, 20, 0, 0),
            urgent=False,
            helpers_min_count=2,
            helpers_max_count=2,
            published=True,
        ...
        HelperTaskEntity(
            ...
            deadline=datetime(CURRENT_YEAR, 12, 4, 20, 20),
            helpers_min_count=2,
            helpers_max_count=3,
            urgent=False,
            published=True,
        ...
        HelperTaskEntity(
            ...
            deadline=datetime(CURRENT_YEAR, 12, 4, 20, 30),
            helpers_min_count=1,
            helpers_max_count=1,
            urgent=True,
            published=True,
